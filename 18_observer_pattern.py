...
class AnimalPark:
    ...
    def add_animal(self, anim):
        ...
        # isinstance verifica daca anim este o instanta a unei clase
        # care este ori Animal, ori mosteneste Animal, ori mosteneste orice alta clasa care mosteneste Animal.
...
class Animal:
    ...
    # metoda este clonata si in clasa Dog si inclasa Cat
    def speak(self):
