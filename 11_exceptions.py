...
try:
    ...
    print(lista1[vari])
    # exception that is throw from the int() conversion is caught as/ a ValueError, exception that
    # is thrown when accesing a non-existing index is caught, IndexError.
except IndexError:
