...
# @ staticmethod. O metoda care are legatura cu conturi bancare, dar nu are legatura cu
# un cont anume sau informatii dintr_un "self" anume
...
# __ is a private proprety, cannot accessed from outside of the class
